...
![alt text](https://github.com/aamodbk/iiitb_RISCV_design/blob/main/valid_pip.png)

Type the following code to implement valid signals for pipelined logic.
...
### Register File Bypass To Address Read-After-Write Hazard
...
### Final 4 staged RISC-V pipeline
...
![alt text](https://github.com/aamodbk/iiitb_RISCV_design/blob/main/riscv_mc.png)
